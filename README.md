...
* `POST /api/v1/donations/` - Create a new food donation (Auto-calculates AI urgency & links to logged-in donor)
* `PATCH /api/v1/donations/{donation_id}/claim` - Claim a donation (NGO/Volunteer only)
* `GET /api/v1/donations/my-claims` - Fetch a history of claims made by the logged-in user
